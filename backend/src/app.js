...
const cashReceiptPaymentRoutes = require("./routes/cashReceiptPayment.routes");
const voucherRoutes = require("./routes/voucher.routes");
const billRoutes = require("./routes/bill.routes");
const salesRoutes = require("./routes/sales.routes");
const purchaseRoutes = require("./routes/purchase.routes");
const brickPurchaseRoutes = require("./routes/brick/purchase.routes");
const brickDeliveryRoutes = require("./routes/brick/delivery.routes");
const brickDumperRoutes = require("./routes/brick/dumper.routes");
const brickJcbRoutes = require("./routes/brick/jcb.routes");
...
app.use("/api/cash-receipt-payment", cashReceiptPaymentRoutes);
app.use("/api/voucher", voucherRoutes);
app.use("/api/bill", billRoutes);
app.use("/api/sales", salesRoutes);
app.use("/api/purchase", purchaseRoutes);
app.use("/api/brick-purchase", brickPurchaseRoutes);
app.use("/api/brick-delivery", brickDeliveryRoutes);
app.use("/api/brick-dumper", brickDumperRoutes);
app.use("/api/brick-jcb", brickJcbRoutes);
