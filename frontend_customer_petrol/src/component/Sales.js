...
const Sales = () => {
    ...
    const dateBodyTemplate = (row) => {
        if (!row.date) return "-";
        return new Date(row.date).toLocaleString("en-IN");
    };
                ...
                <div className="sales-modal-backdrop">
                    <div className="sales-modal">
                        ...
                        <div className="d-flex justify-content-end gap-2">
                            <button type="button" className="btn btn-outline-secondary" onClick={handleAddMoreNo}>
                                No, Save Sale
                            </button>
                            <button type="button" className="btn btn-primary" onClick={handleAddMoreYes}>
                                Yes, Add More
                            </button>
                        </div>
                    </div>
